...
public:
    ...
    // keep track of dsq count to prevent peernodes from gaming obfuscation queue
    int64_t nDsqCount;
    ...
    /// Find an entry in the peernode list that is next to be paid
    ...
    /// Update peernode list and maps using provided CMasternodeBroadcast

...
//
// The Masternode Ping Class : Contains a different serialize method for sending pings from peernodes throughout the network
//
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 1000 LYTX, signature to prove
...
//
// The Masternode Broadcast Class : Contains a different serialize method for sending peernodes through the network
//

...
//
// CBudgetVote - Allow a maxnode node to vote and broadcast throughout the network
//
...
//
// CFinalizedBudgetVote - Allow a maxnode node to vote and broadcast throughout the network
//
